...
public class newaccountadmin extends javax.swing.JFrame {
        Connection con=null;
        Statement ste=null;
        ResultSet rs=null;
    ...
    private void btnCreateAccountActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
    		...
    		if(txtPassword1.getText().trim().equals(txtConfrimPassword.getText().trim()))
    	{
    		...
    		try {
        		...
        		ste.execute("INSERT Into tbladminsignup(admin_name, admin_password)VALUE('"+name+"','"+pass+"')");
        		}
        catch(Exception ex)
        	{
        	}
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newaccountadmin().setVisible(true);
            }
        });
    }
